...
const fallbackDefinitions = {
  categories: ["MAIN_OPERATION", "ST_OPERATION", "OPERATION_CODE", "ST_GROUP", "RESOURCE", "SCHEDULE_STATUS", "PHYSICAL_AREA", "SCHEDULE_AREA", "PLANNER", "RECIPE_GROUP", "PAINT_TYPE", "RECIPE", "RECIPE_SOURCE_FIELD", "PROCESS_TIME_PROFILE", "PROCESS_TIME_SOURCE_FIELD", "CONFIG_CATEGORY", "LINK_TYPE", "RULE_TYPE"],
  linkTypes: ["OPERATION_TO_MAIN", "MAIN_TO_ST_GROUP", "ST_GROUP_TO_PHYSICAL_AREA", "MAIN_TO_PHYSICAL_AREA", "PHYSICAL_TO_SCHEDULE_AREA", "SCHEDULE_AREA_TO_PLANNER", "OPERATION_TO_RESOURCE", "OPERATION_TO_RECIPE_GROUP", "MAIN_TO_RESOURCE", "MAIN_TO_RECIPE_GROUP", "RECIPE_TO_PROCESS_TIME_PROFILE", "MAIN_TO_DEFAULT_RECIPE"],
  ruleTypes: ["PRIORITY", "PROCESS_TIME", "BATCH", "RECIPE", "PLANNING_ELIGIBILITY", "CANDIDATE", "AUTO_PLAN", "ROUTE"],
};
