...
const fallbackDefinitions = {
  categories: ["MAIN_OPERATION", "ST_OPERATION", "OPERATION_CODE", "ST_GROUP", "RESOURCE", "SCHEDULE_STATUS", "PHYSICAL_AREA", "SCHEDULE_AREA", "PLANNER", "RECIPE_GROUP", "PAINT_TYPE", "CONFIG_CATEGORY", "LINK_TYPE", "RULE_TYPE"],
  linkTypes: ["OPERATION_TO_MAIN", "MAIN_TO_ST_GROUP", "ST_GROUP_TO_PHYSICAL_AREA", "MAIN_TO_PHYSICAL_AREA", "PHYSICAL_TO_SCHEDULE_AREA", "SCHEDULE_AREA_TO_PLANNER", "OPERATION_TO_RESOURCE", "OPERATION_TO_RECIPE_GROUP", "MAIN_TO_RESOURCE", "MAIN_TO_RECIPE_GROUP"],
