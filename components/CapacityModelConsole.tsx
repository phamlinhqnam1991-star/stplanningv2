...
export function CapacityModelConsole(){
  ...
  return <div className="stack">
    ...
    <section className="panel">
      ...
      <div className="output-config-note"><strong>Configuration-first scheduling · v020.2 route prerequisite batch gate active</strong><span>Chemical Line uses segmented Flybar logic; wet painting uses recipe-aware Cabin segments; Masking/Unmasking follow each Job full route exactly, retain route context for batching, and reserve both a workstation and a shared operator pool. Qty × standard min/pc is converted into elapsed time using configurable operator allocation and parallel efficiency. A Main Operation batch starts only after every member Job is route-ready; direct Masking/Unmasking prerequisite batches are aggregated and exposed as the batch start gate.</span></div>
