...
export function CapacityModelConsole(){
  ...
  return <div className="stack">
    ...
    <section className="panel">
      ...
      <div className="output-config-note"><strong>Configuration-first scheduling · v024 What-if / Target Optimizer active</strong><span>Chemical Line, Painting, Masking/Unmasking and manpower remain finite-capacity constrained. Every Main Operation batch starts only after all member Jobs are route-ready. v024 keeps the complete dependency graph, Smart Batch Split, critical-path/bottleneck/recovery and backward target plan, then adds simulation-only resource outage, concurrency, manpower and cutoff what-if trials. Nothing is written into the real plan.</span></div>
