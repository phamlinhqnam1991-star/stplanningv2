...
export function CapacityModelConsole(){
  ...
  return <div className="stack">
    ...
    <section className="panel">
      ...
      <div className="output-config-note"><strong>Configuration-first scheduling · v023 Target Backward Batch Generator active</strong><span>Chemical Line, Painting, Masking/Unmasking and manpower remain finite-capacity constrained. Every Main Operation batch starts only after all member Jobs are route-ready. v023 keeps the complete dependency graph, Smart Batch Split, critical-path/bottleneck/recovery engine, and adds a backward requirement plan from FINSST cutoff to every required upstream batch, recipe, area and planner deadline. Nothing is written into the real plan.</span></div>
