...
export function CapacityModelConsole(){
  ...
  return <div className="stack">
    ...
    <section className="panel">
      ...
      <div className="output-config-note"><strong>Configuration-first scheduling · v021 dependency graph + Smart Batch Split active</strong><span>Chemical Line, Painting, Masking/Unmasking and manpower remain finite-capacity constrained. Every Main Operation batch starts only after all member Jobs are route-ready. v021 also exposes the complete batch-to-batch Job dependency graph and can trial-split proposed batches when a late subset blocks ready Jobs; the split is retained only when full re-simulation improves ST Output target recovery.</span></div>
