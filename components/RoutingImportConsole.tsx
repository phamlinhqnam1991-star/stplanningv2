...
import type { ParsedRoutingWorkbook } from "@/lib/types";
...
export function RoutingImportConsole() {
  ...
  async function chooseFile(file: File | null) {
    ...
    try {
      const result = await parseRoutingWorkbook(file, setParseProgress);
  ...
  async function runImport() {
    ...
    setValidation(null);
    try {
      const result = await importRoutingWorkbook(parsed, sha256, setProgress);
    ...
    <div className="stack">
      <section className="panel intake-panel routing-intake">
        <div className="panel-head">
          ...
          <span className="badge routing">36 OPERATION SLOTS</span>
        </div>
        <div className="intake-grid">
          <label className="file-zone route-zone">
            ...
            <span>Imports the full per-Job route: Op.1…Op.36 + OpC + OprSeq + OpenNonConfOp.</span>
          </label>
          ...
          <div className="sheet-cards one-card">
            <div className="sheet-card routing-card">
              ...
              <div className="metric-row">
                ...
                <div><small>ROUTE SLOTS</small><strong>36</strong></div>
              </div>
            </div>
          </div>
