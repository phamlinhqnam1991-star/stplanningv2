...
const FALLBACK_ITEM_CATEGORIES = ["MAIN_OPERATION", "ST_OPERATION", "OPERATION_CODE", "RESOURCE", "SCHEDULE_STATUS", "PHYSICAL_AREA", "SCHEDULE_AREA", "PLANNER", "RECIPE_GROUP", "PAINT_TYPE", "RECIPE", "RECIPE_SOURCE_FIELD", "PROCESS_TIME_PROFILE", "PROCESS_TIME_SOURCE_FIELD", "CONFIG_CATEGORY", "LINK_TYPE", "RULE_TYPE"];
