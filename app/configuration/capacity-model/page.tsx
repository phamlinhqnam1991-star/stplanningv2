...
export default function CapacityModelPage(){
  return <div className="page"><PageHeader code="CFG-95" title="Finite Capacity Model" description="Configure Flybar segments, wet-paint CAB1–CAB4 eligibility/stages, Masking/Unmasking manpower, full-route dependencies, Smart Batch Split, Critical Path / Bottleneck / Recovery thresholds, physical resource slots and finite-capacity target policy."/><CapacityModelConsole/></div>;
}
